...
$(function() {
	...
	$('#question1').click(function (){
        ...
        localStorage.setItem("iconQuestionECA",iconClassValue);
        alert('Icono Seleccionado'+iconClassValue);
    });
    $('#question2').click(function (){
    	var iconClassValue2 = $('#question2').attr('class');
        localStorage.setItem("iconQuestionECA",iconClassValue2);
    });
    $('#question3').click(function (){
    	var iconClassValue3 = $('#question3').attr('class');
        localStorage.setItem("iconQuestionECA",iconClassValue3);
    });
});
